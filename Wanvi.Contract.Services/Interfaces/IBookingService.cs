...
namespace Wanvi.Contract.Services.Interfaces
{
    ...
    bool ascending = true);
        ...
        Task<string> CancelBookingNoDepositForCustomer(CancelBookingForCustomerModel model);
        ...
        Task<string> CompleteBookingForTourGuide(CompleteBookingForTourGuideModel model);
    }
